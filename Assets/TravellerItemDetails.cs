...
public class TravellerItemDetails : MonoBehaviour
{
    public Item item;
    public Image image;
    ...
    public TravelerShopScript travelerShop;
    private void Start()
    {

        travelerShop = FindObjectOfType<TravelerShopScript>();
