...
public class FlyTotem : MonoBehaviour
{
    public GameObject flyPrefab; // Prefab to instantiate
    ...
    private IEnumerator InstantiateSlimesAfterDelay()
    {
        ...
        for (int i = 0; i < prefabCount; i++)
        {
            ...
            fly.transform.parent = transform; // Set the parent as the current SlimeHorde instance
            instantiatedPrefabs++;
        }
    }
